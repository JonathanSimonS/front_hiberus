...
let getAparcamientos = async (url) => {
    try {
        ...
        aparcamientos.forEach(aparcamiento => {
            ...
            $titulo.classList.add('fila-item')
            $plazas.classList.add('fila-item')
            $anclajes.classList.add('fila-item')
            ...
            $titulo.innerHTML = `<i class="bi bi-geo-fill" style="font-size: 1.5rem;"></i><h2>${aparcamiento.title}</h2>`
            $plazas.innerHTML = `<i class="bi bi-bicycle" style="font-size: 1.5rem;"></i><h3>Plazas: ${aparcamiento.plazas}</h3>`
            $anclajes.innerHTML = `<i class="bi bi-check-circle" style="font-size: 1.5rem;"></i><h3>Anclajes: ${aparcamiento.anclajes}</h3></br>`
